...
class NinthLevelActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        showDialog()
        addQAs(ImagesQA(R.drawable.egipetskie_piramidy,"Египет пирамидасы", "Кызыл аянт", "Колизей", "Египет пирамидасы"))
        addQAs(ImagesQA(R.drawable.kolizey,"Лувр", "Кызыл аянт", "Колизей", "Колизей"))
        addQAs(ImagesQA(R.drawable.bigben,"Стоунхендж", "Биг-Бен", "Тадж-Махал", "Биг-Бен"))
        addQAs(ImagesQA(R.drawable.kaaba,"Кааба", "Мачу-Пикчу", "Эркиндик айкели", "Кааба"))
        addQAs(ImagesQA(R.drawable.luvr,"Колизей", "Мачу-Пикчу", "Лувр", "Лувр"))
        addQAs(ImagesQA(R.drawable.machu_pikchu,"Мачу-Пикчу", "Тадж-Махал", "Стоунхендж", "Мачу-Пикчу"))
        addQAs(ImagesQA(R.drawable.statuya_svobody,"Египет пирамидасы", "Эркиндик айкели", "Колизей", "Эркиндик айкели"))
        addQAs(ImagesQA(R.drawable.stounhandj,"Биг-Бен", "Улуу кытай дубалы", "Стоунхендж", "Стоунхендж"))
        addQAs(ImagesQA(R.drawable.tadj_mahal,"Тадж-Махал", "Лувр", "Кааба", "Тадж-Махал"))
        addQAs(ImagesQA(R.drawable.velikaya_kitayskaya_stena,"Египет пирамидасы", "Лувр", "Улуу кытай дубалы", "Улуу кытай дубалы"))
        listQA.shuffle()
        qa = listQA[index]
        setAllQA()
...
//            binding.option1.setTextColor(Color.GREEN)
    ...
    fun showDialog(){
        ...
        val closeDialog = dialog.findViewById(R.id.close_dialog) as ImageView
        with(dialog){
            findViewById<TextView>(R.id.text_alert_dialog).text = getString(R.string.text_for_level_ninth)
        }
        dialog.window!!.setBackgroundDrawable(ColorDrawable(Color.TRANSPARENT))
